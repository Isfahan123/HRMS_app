...
from gui.leave_management.pending_requests import PendingLeaveRequestsWidget
from gui.leave_management.history import LeaveHistoryWidget
...
try:
    from gui.admin_sections.leave.leave_caps_editor import LeaveCapsEditor
except Exception as e:
...
try:
    from gui.admin_sections.leave.leave_policy_editor import LeavePolicyEditor
except Exception as e:
